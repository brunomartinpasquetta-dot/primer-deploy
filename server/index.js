...
app.use('/api/notas-credito',    requireAuth, encargadoOAdmin, require('./routes/notas-credito'));
app.use('/api/auditorias',        requireAuth, soloAdmin, require('./routes/auditorias'));
app.use('/api/trazabilidad',      requireAuth, encargadoOAdmin, require('./routes/trazabilidad'));
